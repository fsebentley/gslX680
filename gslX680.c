 ...
 *
 *  Modified By David Bentley<fsebentley@yahoo.com>
 *  Using Code written by Joe Burmeister<joe.a.burmeister@gmail.com>
 *  Driver now Loads Firmware from a File named gslX680.fw located
...
static char* fwname;
static char gsl_firmware[64] = {"gslX680.fw"};
